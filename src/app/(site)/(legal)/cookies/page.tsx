    ...
    <div className="min-h-screen bg-dark-6 text-white pt-24 pb-16 px-6">
      <div className="max-w-3xl mx-auto prose prose-invert">
        ...
        <p className="text-grey-60 leading-relaxed mb-4">
          NightKing uses essential cookies and similar storage (including local browser storage) to keep you signed in,
        ...
        <p className="text-grey-60 leading-relaxed">
          Contact: <a className="text-red-45" href="mailto:support@nightking.tv">support@nightking.tv</a>
        </p>
      </div>
    </div>
  );
