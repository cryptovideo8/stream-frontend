  ...
  return (
    <div className="min-h-screen bg-dark-6 text-white pt-24 pb-16 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-grey-70 text-sm mb-8">Last updated: July 10, 2026</p>
        <p className="text-grey-60 leading-relaxed mb-4">
          NightKing respects intellectual property rights. If you believe content on the platform infringes your copyright,
        ...
        <p className="text-grey-60 leading-relaxed mb-4">
          Send notices to: <a className="text-red-45" href="mailto:support@nightking.tv">support@nightking.tv</a>
        </p>
