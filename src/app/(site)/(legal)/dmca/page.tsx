  ...
  return (
    <div className="min-h-screen bg-dark-6 text-white pt-24 pb-16 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <h2 className="text-xl font-semibold text-white mt-8 mb-3">Designated agent</h2>
        <p className="text-grey-60 leading-relaxed mb-4">
          ...
          <br />
          Subject line: <span className="text-white">DMCA Notice — {BRAND.name}</span>
        </p>

        <h2 className="text-xl font-semibold text-white mt-8 mb-3">Notice requirements</h2>
        ...
        <h2 className="text-xl font-semibold text-white mt-8 mb-3">Counter-notification</h2>
        <p className="text-grey-60 leading-relaxed mb-4">
        ...
        <h2 className="text-xl font-semibold text-white mt-8 mb-3">Repeat infringers</h2>
