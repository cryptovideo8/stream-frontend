...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-20 left-0 right-0 z-[99990] px-4 md:bottom-6 md:left-6 md:right-auto md:max-w-md">
      <div className="rounded-2xl border border-white/10 bg-dark-10/95 p-4 shadow-2xl backdrop-blur-md">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="rounded-lg border border-dark-25 px-3 py-2 text-xs font-medium text-grey-70 hover:text-white"
          >
            Essential only
          </button>
          <button
